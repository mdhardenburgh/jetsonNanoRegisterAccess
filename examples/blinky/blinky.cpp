...
{   
    ...
    //std::cout<<myPinMuxController.getRegisterField(PINMUX_AUX_SPI2_SCK_0::addressOffset, PINMUX_AUX_SPI2_SCK_0::TRISTATE_bit, PINMUX_AUX_SPI2_SCK_0::TRISTATE_bitWidth)<<std::endl;
